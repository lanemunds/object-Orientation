...
// }
// }
// let dumbledore = new Wizard('Dumbledore', 5004, 'avada kadavre')

// console.log(dumbledore.favoriteSpell)
...
let phone1 = new Phone('apple', 'iphone', 1, 'black', 500)
let phone2 = new Phone('samsung', 'galaxy', '2', 'red', 501)
let phone3 = new Phone('google','pixel', '3', 'blue', 450 )
...
let myFirstMotorcycle = new Motorcycle (2,'black', 100, 'hondo', 'hell yeah')
...
checkSeaWorthiness(){
  if(this.isSeaWorthy === true){
    ...
    console.log(`you need to get this ${this.type} in shape`)
  }
}
performMaintanance(){
...
*/
let myFirstBoat = new Boat(6,'black',20000,'biggest baby', 'yamaha',false)
...
myFirstBoat.performMaintanance()
